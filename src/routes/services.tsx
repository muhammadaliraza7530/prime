...
const services = [
  {
    ...
    description:
      "Custom residential and commercial architecture that blends modern function with Lahore’s local style.",
  },
  {
    Icon: Layers,
  ...
  },
  {
    ...
    description:
      "Property advisory, buying, selling and investment support for prime Lahore residential and commercial plots.",
  },
  {
    Icon: ClipboardList,
  ...
  head: () => ({
    meta: [
      { title: "Services — Prime Services Construction Lahore" },
      {
        name: "description",
        content:
          "Prime Services delivers architecture, grey structure, interior design, finishing and project management across Lahore.",
      },
      { property: "og:title", content: "Services — Prime Services Construction Lahore" },
      {
        property: "og:description",
        content:
          "Discover Prime Services’ full construction services in Lahore, from grey structure to turnkey interiors and real estate support.",
      },
            ...
            <div className="relative z-10 grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
              ...
              <div className="flex flex-col gap-4">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="btn-hero group/btn inline-flex items-center justify-center gap-2 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-primary/20"
                >
