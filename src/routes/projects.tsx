...
const projectImages = [
  ...
  { src: "/projectImages/img2.png", title: "Spanish Villa Finish", location: "Lahore" },
  { src: "/projectImages/img3.png", title: "Luxury Family Home", location: "Lahore" },
  { src: "/projectImages/img4.png", title: "Modern Office Plaza", location: "Lahore" },
  { src: "/projectImages/img5.png", title: "Grey Structure Mastery", location: "Lahore" },
  { src: "/projectImages/img6.png", title: "Contemporary Villa", location: "Lahore" },
  { src: "/projectImages/img7.png", title: "Turnkey Interior Suite", location: "Lahore" },
  { src: "/projectImages/img8.png", title: "Premium Duplex Project", location: "Lahore" },
  { src: "/projectImages/img9.png", title: "Commercial Fit-Out", location: "Lahore" },
  { src: "/projectImages/img10.png", title: "Modern Bathroom Upgrade", location: "Lahore" },
  { src: "/projectImages/img11.png", title: "Elegant Living Area", location: "Lahore" },
  { src: "/projectImages/img12.png", title: "Park View Residence", location: "Lahore" },
  { src: "/projectImages/img13.png", title: "Luxury Kitchen Remodel", location: "Lahore" },
  { src: "/projectImages/img14.png", title: "Contemporary Facade", location: "Lahore" },
  { src: "/projectImages/img15.png", title: "Signature Family Home", location: "Lahore" },
];
  ...
  head: () => ({
    meta: [
      { title: "Projects — Prime Services Lahore" },
      {
        name: "description",
        content:
          "View Prime Services’ Lahore construction portfolio with real project images, design work, and built structures.",
      },
      { property: "og:title", content: "Projects — Prime Services Lahore" },
      {
        property: "og:description",
        content:
          "Browse the Prime Services project gallery in Lahore, showing finished builds, structures, interiors and exterior work.",
      },
...
function Reveal({ children, delay = 0, className = "" }) {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ...
      { threshold: 0.1 } // Slightly lower threshold for images
    );
            ...
            <Reveal>
              <div>
                ...
                <h1 className="mt-6 font-display text-4xl font-black leading-[1.1] tracking-tight text-white md:text-6xl">
                  Built Lahore projects with real images, quality finishes and strong structure.
                </h1>
                <p className="mt-8 max-w-2xl text-lg leading-relaxed text-slate-300 md:text-xl">
                  Explore our gallery of completed and in-progress builds across Lahore. Each image highlights the strength, craftsmanship and finish quality you can expect from Prime Services.
                </p>
              ...
              <div className="relative grid grid-cols-2 gap-4 rounded-[2.5rem] border border-white/10 bg-white/[0.03] p-4 shadow-2xl shadow-black/40 backdrop-blur-xl">
                ...
                <div className="group relative col-span-2 flex flex-col justify-between overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-br from-primary/20 to-dark p-8 transition-all duration-500 hover:border-primary/40">
                  ...
                  <div className="relative z-10 flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-xs uppercase tracking-[0.3em] text-primary">Project Gallery</p>
                      <h2 className="mt-1 text-2xl font-black text-white">Real builds. Real results.</h2>
                    </div>
                  </div>
                  <p className="relative z-10 mt-6 max-w-md text-sm leading-relaxed text-slate-200">
                    Real project images from our completed and active builds in Lahore.
                  </p>
                </div>
                ...
                <div className="group relative overflow-hidden rounded-[1.5rem] border border-white/10 bg-dark/40 p-6 transition-all duration-300 hover:bg-white/10 hover:-translate-y-1">
                  ...
                  <p className="mt-2 text-4xl font-black text-white transition-colors duration-300 group-hover:text-primary">2005</p>
                ...
                <div className="group relative overflow-hidden rounded-[1.5rem] border border-white/10 bg-dark/40 p-6 transition-all duration-300 hover:bg-white/10 hover:-translate-y-1">
                  <p className="text-[0.65rem] uppercase tracking-[0.25em] text-slate-400">Projects Shown</p>
                  <p className="mt-2 text-4xl font-black text-white transition-colors duration-300 group-hover:text-primary">15+</p>
                  <div className="absolute -bottom-4 -right-4 h-16 w-16 rounded-full bg-primary/10 blur-xl transition-transform duration-500 group-hover:scale-150"></div>
                </div>
              </div>
            </Reveal>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {projectImages.map((project, i) => (
            <Reveal key={project.src} delay={(i % 3) * 100}>
              <article className="group relative h-full overflow-hidden rounded-[2rem] border border-border bg-card shadow-lg shadow-black/5 transition-all duration-500 hover:-translate-y-2 hover:shadow-xl hover:shadow-primary/10 hover:border-primary/30">
                {/* Top Sliding Accent */}
                ...
                <div className="relative aspect-[4/3] overflow-hidden">
                  ...
                  <img
                    ...
                    loading="lazy"
                    decoding="async"
                    className="absolute left-4 top-4 z-10 h-12 w-12 rounded-full border border-white/40 bg-white/90 p-2 shadow-xl backdrop-blur-sm transition-all duration-500 group-hover:scale-110 group-hover:border-primary"
                  />
                  
                  {/* Content */}
                  <div className="absolute inset-x-0 bottom-0 z-10 p-6 text-white">
                    <div className="flex items-center gap-2 text-[0.65rem] uppercase tracking-[0.25em] text-primary transition-all duration-500 group-hover:tracking-[0.3em]">
                      <MapPin size={12} /> {project.location}
                    </div>
                    <h3 className="mt-2 text-xl font-bold text-white transition-transform duration-500 group-hover:translate-x-1">
                      {project.title}
                    </h3>
