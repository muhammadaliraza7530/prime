    ...
    <main className="bg-background text-dark-foreground">
        ...
        <div className="mx-auto grid max-w-6xl gap-12 px-4 py-24 md:grid-cols-2 md:px-6">
          <div className="flex flex-col justify-center max-w-2xl">
            <Reveal>
              ...
              <h1 className="mt-6 font-display text-4xl font-black leading-tight tracking-tight text-white md:text-6xl">
          ...
          <div className="grid gap-4">
            <Reveal delay={200}>
              <div className="group relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/5 shadow-2xl shadow-black/10 transition-all duration-500 hover:scale-[1.02] hover:shadow-primary/20">
                <img
            ...
            <Reveal delay={400}>
              <div className="grid grid-cols-3 gap-4">
                {[
                  ...
                  <div 
                    key={i} 
                    className="group rounded-3xl border border-white/10 bg-white/5 p-5 text-center text-white shadow-xl shadow-black/10 transition-all duration-300 hover:bg-white/10 hover:-translate-y-2 cursor-default"
                  >
                    <p className="text-3xl font-black text-white transition-colors duration-300 group-hover:text-primary">{stat.val}</p>
                    <p className="mt-2 text-xs uppercase tracking-[0.25em] text-slate-300 transition-all duration-300 group-hover:tracking-[0.3em]">{stat.label}</p>
                  </div>
                ))}
              </div>
            </Reveal>
            ...
            <Reveal delay={500}>
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="group rounded-3xl border border-border bg-card p-6 shadow-lg shadow-black/5 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-primary/10 hover:border-primary/20">
                  <p className="text-xs uppercase tracking-[0.25em] text-muted-foreground">Premium</p>
                  <h3 className="mt-3 text-lg font-bold text-foreground transition-colors duration-300 group-hover:text-primary">Quality Craftsmanship</h3>
                  <p className="mt-2 text-sm text-muted-foreground">
                    Every project is built with the best materials and rigorous quality checks.
                  </p>
                </div>
                <div className="group rounded-3xl border border-border bg-card p-6 shadow-lg shadow-black/5 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-primary/10 hover:border-primary/20">
                  <p className="text-xs uppercase tracking-[0.25em] text-muted-foreground">Trusted</p>
                  <h3 className="mt-3 text-lg font-bold text-foreground transition-colors duration-300 group-hover:text-primary">Client-first Service</h3>
                  <p className="mt-2 text-sm text-muted-foreground">
      ...
      <section className="relative overflow-hidden bg-background py-20">
        <div className="mx-auto max-w-6xl px-4 md:px-6">
          <Reveal>
            <div className="group relative rounded-[2rem] bg-dark p-8 md:p-12 shadow-2xl shadow-black/20 overflow-hidden transition-all duration-500 hover:shadow-primary/10">
              ...
              <Quote className="absolute top-8 right-8 text-primary/10 transition-all duration-500 group-hover:scale-110 group-hover:text-primary/20" size={80} />
              ...
              <div className="relative z-10 max-w-3xl">
                ...
                <p className="mt-8 border-t border-white/10 pt-6 text-sm uppercase tracking-[0.3em] text-slate-400">
          ...
          <Reveal>
            <div>
              ...
              <div className="mt-8 grid grid-cols-2 gap-4">
                <div className="group rounded-2xl border border-border bg-card p-5 transition-all duration-300 hover:-translate-y-1 hover:border-primary/30 hover:bg-primary/5">
                  <p className="text-3xl font-black text-foreground transition-colors duration-300 group-hover:text-primary">15+</p>
                  <p className="mt-1 text-sm text-muted-foreground">Expert Engineers</p>
                </div>
                <div className="group rounded-2xl border border-border bg-card p-5 transition-all duration-300 hover:-translate-y-1 hover:border-primary/30 hover:bg-primary/5">
                  <p className="text-3xl font-black text-foreground transition-colors duration-300 group-hover:text-primary">A+</p>
                  <p className="mt-1 text-sm text-muted-foreground">Material Grade</p>
                </div>
              </div>
            </div>
          </Reveal>
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            {[
              ...
              <Reveal key={i} delay={i * 150}>
                <div className="group h-full rounded-[2rem] border border-border bg-card p-8 shadow-lg shadow-black/5 transition-all duration-500 hover:-translate-y-2 hover:shadow-xl hover:shadow-primary/10 hover:border-primary/20">
                  <span className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-primary/10 text-primary transition-all duration-500 group-hover:bg-primary group-hover:text-white group-hover:scale-110 group-hover:rotate-6">
                    <feature.Icon size={22} />
                  </span>
                  <h3 className="mt-6 text-xl font-bold text-foreground transition-colors duration-300 group-hover:text-primary">{feature.title}</h3>
          ...
          <div className="grid gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            ...
            <div className="grid gap-4">
              {[
                ...
                <Reveal key={i} delay={i * 150}>
                  <div className="group relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-xl shadow-black/10 transition-all duration-500 hover:bg-white/10 hover:border-primary/20 hover:pl-12">
                    <span className="absolute right-6 top-6 text-5xl font-black text-white/5 transition-all duration-500 group-hover:text-primary/20 group-hover:scale-110">
                      {step.num}
                    </span>
                    <h3 className="mt-2 text-2xl font-black text-white transition-colors duration-300 group-hover:text-primary">{step.title}</h3>
                    <p className="mt-3 text-sm text-slate-300 max-w-md">{step.desc}</p>
                  </div>
                </Reveal>
              ))}
            </div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-20 md:px-6">
        <div className="grid gap-8 lg:grid-cols-3">
          {[
            ...
            <Reveal key={i} delay={i * 150}>
              <div className="group relative h-full overflow-hidden rounded-[2rem] border border-border bg-card p-8 shadow-lg shadow-black/5 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-primary/10 hover:border-primary/20">
                ...
                <div className="relative z-10 h-full flex flex-col">
                  <p className="text-sm font-bold uppercase tracking-[0.3em] text-muted-foreground">{card.label}</p>
                  
                  {card.title && <h3 className="mt-4 text-2xl font-black text-foreground">{card.title}</h3>}
                  
                  {card.content && <p className="mt-4 text-sm leading-relaxed text-muted-foreground">{card.content}</p>}
                  ...
                  {card.cta && (
                    ...
                    >
                      <span className="inline-flex items-center gap-2 rounded-full bg-whatsapp px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-whatsapp/20 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-whatsapp/40">
                        <Phone size={18} className="transition-transform duration-300 group-hover:rotate-12" /> WhatsApp {WHATSAPP_DISPLAY}
                      </span>
                    </a>
                  )}
                </div>
