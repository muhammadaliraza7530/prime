...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact Us — Prime Services Pakistan" },
      {
        name: "description",
        content:
          "Get in touch with Prime Services for site visits, estimates, and construction support across Punjab & Pakistan.",
      },
      { property: "og:title", content: "Contact Us — Prime Services Pakistan" },
      {
        property: "og:description",
        content:
          "Contact Prime Services for construction, interior design and real estate project assistance across major Pakistani cities.",
      },
...
function ContactPage() {
  return (
    <main className="bg-background text-dark-foreground">
            ...
            <Reveal>
              <div>
                ...
                <h1 className="mt-6 font-display text-4xl font-black leading-[1.1] tracking-tight text-white md:text-6xl">
                  Speak with Prime Services Pakistan today.
                </h1>
                <p className="mt-8 max-w-2xl text-lg leading-relaxed text-slate-300 md:text-xl">
                  Our team is available for consultations, site visits, quotations and project
                  planning. Reach out via WhatsApp, phone, or email and we will respond quickly.
                </p>
            ...
            <Reveal delay={200}>
              <div className="relative grid grid-cols-2 gap-4 rounded-[2.5rem] border border-white/10 bg-white/[0.03] p-4 shadow-2xl shadow-black/40 backdrop-blur-xl">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="col-span-2 mt-4 inline-flex items-center justify-center gap-2 rounded-full bg-white/10 px-5 py-3 text-xs font-bold text-white shadow-lg shadow-whatsapp/20 transition-all duration-300 hover:scale-105 hover:shadow-xl"
                >
                  Chat on WhatsApp: 03125438005 <Send size={14} />
                </a>
                
                <div className="group relative col-span-2 overflow-hidden rounded-[1.5rem] border border-white/10 bg-dark/40 p-6 transition-all duration-300 hover:bg-white/10 hover:-translate-y-1">
                  <Mail
                    size={20}
                    className="text-primary transition-transform duration-300 group-hover:scale-110"
                  />
                  <p className="mt-3 text-[0.65rem] uppercase tracking-[0.25em] text-slate-400">
                    Email
                  </p>
                  <p className="mt-1 text-sm font-black text-white transition-colors duration-300 group-hover:text-primary break-all">
                    {EMAIL}
                  </p>
      ...
      {/* Form Section */}
      <section className="relative mx-auto max-w-4xl px-4 py-24 md:px-6">
        {/* Form Container */}
        <Reveal>
          <div className="group relative overflow-hidden rounded-[2.5rem] border border-border bg-card p-8 shadow-2xl shadow-black/5 transition-all duration-500 hover:border-primary/20 md:p-12">
            ...
            <div className="relative z-10 text-center md:text-left">
              ...
              <p className="mt-4 max-w-2xl text-sm leading-relaxed text-muted-foreground">
                Use the form to share your project details, and we’ll reply through WhatsApp or
                email shortly.
              </p>
          ...
          <div className="group relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-dark p-10 text-center shadow-2xl shadow-black/20 md:p-16">
            ...
            <div className="relative z-10 mx-auto max-w-3xl">
              ...
              <p className="mt-6 max-w-xl mx-auto text-sm leading-relaxed text-slate-300 md:text-base">
                Whether you’re planning a new build, renovation, or property purchase, Prime
                Services is ready to help with expert advice and a free first consultation.
              </p>
...
function ContactForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="mt-10 space-y-6 text-left">
      ...
      <div
        className={`grid transition-all duration-500 ease-out ${submitted ? "grid-rows-[1fr] opacity-100 mt-4" : "grid-rows-[0fr] opacity-0 mt-0"}`}
      >
