    ...
    <footer className="bg-dark text-dark-foreground">
      <div className="mx-auto max-w-6xl px-4 py-14">
        <div className="grid gap-10 md:grid-cols-3">
          ...
          <div>
            <h3 className="text-sm font-black uppercase tracking-[0.2em] text-primary">Useful Links</h3>
            <nav className="mt-4 grid gap-2.5 text-sm">
              <Link to="/" className="text-dark-muted transition-colors hover:text-dark-foreground">Home</Link>
              <Link to="/about" className="text-dark-muted transition-colors hover:text-dark-foreground">About Us</Link>
              <Link to="/services" className="text-dark-muted transition-colors hover:text-dark-foreground">Services</Link>
              <Link to="/projects" className="text-dark-muted transition-colors hover:text-dark-foreground">Projects</Link>
              <Link to="/contact" className="text-dark-muted transition-colors hover:text-dark-foreground">Contact Us</Link>
            </nav>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 grid gap-3 text-sm text-dark-muted">
              ...
              <li className="flex items-center gap-2.5">
                ...
                <a href={waLink(DEFAULT_WA_MESSAGE)} target="_blank" rel="noreferrer" className="hover:text-dark-foreground">
                  WhatsApp: {WHATSAPP_DISPLAY}
                </a>
              </li>
              <li className="flex items-center gap-2.5">
                <Mail size={16} className="shrink-0 text-primary" />
                <a href={`mailto:${EMAIL}`} className="hover:text-dark-foreground">{EMAIL}</a>
              </li>
              <li className="flex items-start gap-2.5">
                <Truck size={16} className="mt-0.5 shrink-0 text-whatsapp" />
                Serving Lahore, Model Town, Etihad Town &amp; LDA Avenue.
              </li>
            </ul>
          </div>
        </div>
